...
![For Goober's spritesheet, all frames are bounded by a 640px x 640px box.](images/same_frame_bounding_box.png)
...
![Goober hanging out with OCs of different art styles.](images/any_art_style_welcome.png)
...
![Goober is only allowed to speak in interjections; not a passage from a Macintosh ad.](images/no_dialogue.png)
...
![The amount of frames determine the length of the animation.](images/animation_length.png)
